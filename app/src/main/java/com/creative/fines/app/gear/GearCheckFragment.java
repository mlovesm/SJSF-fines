package com.creative.fines.app.gear;
...
public class GearCheckFragment extends Fragment {

    private static final String TAG = "GearCheckFragment";
    private String url;
    private String selectGearKey;

    @Bind(R.id.top_title) TextView textTitle;
    @Bind(R.id.webView1) WebView webView;
    @Bind(R.id.textView1) TextView bottomText;
    private ProgressDialog dialog;

    public GearCheckFragment() {
...
//                            Fragment fm = getFragmentManager().findFragmentByTag("dfdf");
    ...
    public void writeCheck() {
        SettingPreference pref = new SettingPreference("loginData",getActivity());
        String writerSabun = pref.getValue("sabun_no","");
        webView.loadUrl("javascript:fn_gearCheckInsert('" + writerSabun + "')");
    }
